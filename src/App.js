...
function App() {
  ...
  return (
    <div className="App">
      ...
      <Rodal visible={helpModal} onClose={hideHelpModal} customStyles={{ height: 'auto', minHeight: '300px', bottom: 'auto', top: '50%', transform: 'translateY(-50%)', paddingTop: '50px', paddingLeft: '20px', paddingRight: '20px', maxWidth: '80%' }}>
